...
#
# Author: Evan Juras 10/15/18 + modified by Mark Bailey 08/03/2020
#
# Description:
#
...
# If it sees an oven (79) (ie a reflection of the inside of the kitchen after dark) it turns itself off.
#
...
# This section is no longer necessary, for simplicity I've removed the picamera section.
...
def pet_detector(frame,stopBox):
    ...
    # If the top detected object is a cat (17) or a dog (18) (or a potted plant (64)/oven (79) or giraffe (25) for test purposes),
    ...
    # Stop if oven
    if (int(classes[0][0]) == 64):
        print("Oven found, stopping.")
        stopBox = True
...
if camera_type == 'usb':
    ...
    while(True):
        ...
        frame = pet_detector(frame,stopBox)
        print(stopBox)
        # this is where I will break the loop if an oven is found (WIP)
